...
public class PromptUtil {
    ...
    // 对应 TS 中的 EXTENDED_PROMPT_MODEL_PATTERNS
    // 这些模型需要使用扩展的长提示词
    ...
    // 对应 TS 中的 DEFAULT_SYSTEM_PROMPT
    // 注意：Java 文本块会自动处理换行，不需要显式的 \n (除非你需要转义)
    ...
    // 对应 TS 中的 MINIMAL_STYLE_INSTRUCTION
    ...
    // 对应 TS 中的 EXTENDED_SYSTEM_PROMPT
     ...
     * @param minimalStyle 是否使用极简模式 (nullable, default false)
